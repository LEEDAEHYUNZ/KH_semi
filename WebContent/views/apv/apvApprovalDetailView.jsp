...
<body>
	...
	<div>  
      <br>
      <div><h2 class="listTitle">결재현황</h2></div>
      <br>
      <table border="1" class="table-sm" width="90%">
	      ...
	      <!-- 게시글 정보 -->
	      <tr>
	          <th class="table-dark">번호</th> <td><%= a.getApvNo() - 3 %></td>
	          <th class="table-dark">작성자</th> <td><%= a.getApvWriter() %></td>
	      </tr>
	      <tr>
          ...
          <tr>
              <td colspan="4" align="center">
		          ...
		          <% if(loginEmployee != null && loginEmployee.getEmpNo() == 1) { %>
			         <a href="<%= contextPath %>/updateFormApv.ap?ano=<%= a.getApvNo() %>" class="btn btn-warning btn-sm">수정</a>
			         <a href="<%= contextPath %>/deleteApv.ap?ano=<%= a.getApvNo() %>" class="btn btn-danger btn-sm">삭제</a>
		          <% } %>
