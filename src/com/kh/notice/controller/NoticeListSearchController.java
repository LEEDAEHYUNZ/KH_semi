...
/**
 * Servlet implementation class NoticeListSearchController
 */
@WebServlet("/search.no")
public class NoticeListSearchController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NoticeListSearchController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Notice> searchList = new ArrayList<>();
		...
		searchList = new NoticeService().searchList(searchField, searchWord);
		...
		request.getRequestDispatcher("views/notice/noticeSearchedList.jsp").forward(request, response);
