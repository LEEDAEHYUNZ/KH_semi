...
/**
 * Servlet implementation class ApvApprovalDeleteController
 */
@WebServlet("/deleteApv.ap")
public class ApvApprovalDeleteController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ApvApprovalDeleteController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// Service 로 토스
		int result = new ApvApprovalService().deleteApv(apvNo);
