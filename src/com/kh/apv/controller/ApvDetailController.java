...
/**
 * Servlet implementation class ApvDetailControllrt
 */
@WebServlet("/detail.ap")
public class ApvDetailController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ApvDetailController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 응답화면 지정하기
		request.getRequestDispatcher("views/apv/apvDetailView.jsp").forward(request, response);
